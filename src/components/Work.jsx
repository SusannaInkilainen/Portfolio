            ...
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
                <div className="mx-auto max-w-2xl lg:text-center">
                    ...
                    <p className="mt-6 text-lg/8 text-gray-600">
                        Monessa pesusoikossa pesty insinööri, joka on työuransa aikana kerennyt tekemään vähän kaikkea. En pelkää liata käsiäni, enkä pelästy teknisiä asioita tai pelkää purkaa ja kasata laitteita.
                    </p>
                </div>
